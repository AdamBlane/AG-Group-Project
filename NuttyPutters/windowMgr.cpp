...
//	t.join();
	...
	strokeCountTextures.push_back(zeroStrokeLbl);
	...
	strokeCountTextures.push_back(oneStrokeLbl);
	...
	strokeCountTextures.push_back(twoStrokeLbl);
	...
	strokeCountTextures.push_back(threeStrokeLbl);
	...
	strokeCountTextures.push_back(fourStrokeLbl);
	...
	strokeCountTextures.push_back(fiveStrokeLbl);
	...
	strokeCountTextures.push_back(sixStrokeLbl);
	...
	strokeCountTextures.push_back(sevenStrokeLbl);
	...
	strokeCountTextures.push_back(tenStrokeLbl);
	...
	strokeCountTextures.push_back(elevenStrokeLbl);
...
//	textures.insert(std::pair<std::string, Texture*>("twelveStrokeLbl", twelveStrokeLbl));
	strokeCountTextures.push_back(twelveStrokeLbl);
